...
This is a minimal template for a website powered by Node 24.x, ExpressJS and Pug template engine.
...
- Install (`node-foreman`)[https://github.com/strongloop/node-foreman] globally:

```bash
npm install -g foreman
```

- Launch the server with `nf start`.
