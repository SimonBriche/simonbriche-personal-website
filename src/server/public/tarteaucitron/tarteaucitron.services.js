    ...
    window.AdUpRetargeting = function (api) {
      for (var i = 0; i < elements.length; i++) {
        ...
        if (element.getAttribute('device')) {
          var setter =
            'set' + element.getAttribute('device').charAt(0).toUpperCase() + element.getAttribute('device').slice(1);
        ...
        if (element.getAttribute('track')) {
          var tracker =
            'track' + element.getAttribute('track').charAt(0).toUpperCase() + element.getAttribute('track').slice(1);
  ...
  js: function () {
    ...
    tarteaucitron.fallback(['dailymotion_player'], function (x) {
      var frame_title = tarteaucitron.fixSelfXSS(tarteaucitron.getElemAttr(x, 'title') || 'Dailymotion iframe'),
        ...
        params =
          'info=' + tarteaucitron.getElemAttr(x, 'showinfo') + '&autoPlay=' + tarteaucitron.getElemAttr(x, 'autoplay');
...
tarteaucitron.services.recaptcha = {
  ...
  js: function () {
    ...
    if (tarteaucitron.user.recaptchaapi === undefined) {
      ...
      tarteaucitron.addScript(
        'https://www.google.com/recaptcha/api.js?onload=tacRecaptchaOnLoad&render=' + tarteaucitron.user.recaptchaapi
      );
    }
  },
  fallback: function () {
  ...
  js: function () {
    ...
    tarteaucitron.fallback(['vimeo_player'], function (x) {
      var frame_title = tarteaucitron.fixSelfXSS(
          tarteaucitron.getElemAttr(x, 'data-title') || tarteaucitron.getElemAttr(x, 'title') || 'Vimeo iframe'
        ),
        ...
        video_autoplay =
          tarteaucitron.getElemAttr(x, 'data-autoplay') || tarteaucitron.getElemAttr(x, 'autoplay') || '',
        ...
        video_portrait =
          tarteaucitron.getElemAttr(x, 'data-portrait') || tarteaucitron.getElemAttr(x, 'portrait') || '',
...
tarteaucitron.services.getquanty = {
  ...
  js: function () {
    ...
    tarteaucitron.addScript(
      'https://get.smart-data-systems.com/gq?site_id=' + tarteaucitron.user.getguanty + '&consent=1'
    );
  },
  fallback: function () {
    'use strict';
    ...
    tarteaucitron.addScript(
      'https://get.smart-data-systems.com/gq?site_id=' + tarteaucitron.user.getguanty + '&notrack=1'
    );
  },
};
