          ...
          c.settings.onsubmit &&
            ...
            this.on('submit.validate', function (b) {
              ...
              return (
                ...
                c.cancelSubmit ? ((c.cancelSubmit = !1), d())
                : c.form() ?
                  c.pendingRequest ?
                    ((c.formSubmitted = !0), !1)
                  : d()
    ...
    a.extend(a.validator, {
      ...
      prototype: {
        ...
        elementValue: function (b) {
          ...
          return (
            'radio' === f || 'checkbox' === f ? this.findByName(b.name).filter(':checked').val()
          ...
          : ((h = a('<' + this.settings.errorElement + '>')
            ...
            this.settings.wrapper &&
              (d = h
                ...
                .parent()),
            this.labelContainer.length ? this.labelContainer.append(d)
            : this.settings.errorPlacement ? this.settings.errorPlacement.call(this, d, a(b))
            : d.insertAfter(b),
            h.is('label') ?
              h.attr('for', i)
