document.addEventListener('DOMContentLoaded', function () {
  ...
  develop.commit({
    ...
    onMessageClick: function (e) {
      toggleGitTooltip(
        e,
        `Cours Préparatoires aux Grandes Écoles (CPGE), Lycée Louis Thuillier, Amiens
      <ul>
  ...
  feature.commit({
    ...
    onMessageClick: function (e) {
      toggleGitTooltip(
        e,
        `Ecole Supérieure d'Art et de Design (ESAD), Amiens :
      <ul>
      <li>Modèle vivant</li>
      <li>Nature morte</li>
      <li>Peinture</li>
  ...
  develop.commit({
    ...
    onMessageClick: function (e) {
      toggleGitTooltip(
        e,
        `Diplôme d'Études Universitaires Générales (DEUG), Amiens
  ...
  develop.commit({
    ...
    onMessageClick: function (e) {
      toggleGitTooltip(
        e,
        `Institut universitaire professionnalisé (IUP), UVHC, Valenciennes
  ...
  develop.commit({
    ...
    onMessageClick: function (e) {
      toggleGitTooltip(
        e,
        `Master 2 Médias Interactifs, UVHC, Valenciennes
      <ul>
  ...
  feature.commit({
    ...
    onMessageClick: function (e) {
      toggleGitTooltip(
        e,
        "Animation d'un workshop ‘Flash et applications mobiles’ pour e-ArtSup, École de création visuelle (groupe IONIS), Lille"
      );
    },
  });
  master
    .commit({
      ...
      onMessageClick: function (e) {
        toggleGitTooltip(
          e,
          `Responsable de la production technique et R&D à OP1C, Roubaix
      <ul>
  ...
  master
    .commit({
      ...
      onMessageClick: function (e) {
        toggleGitTooltip(
          e,
          `Consultant Senior Architecte Solution à Davidson, Lille
      <ul>
  ...
  feature.commit({
    ...
    onMessageClick: function (e) {
      toggleGitTooltip(
        e,
        `Senior Architect Cloud DevOps Platform Engineer à Decathlon, Btwin Village, Lille
      <ul>
