...
const Util = {
  ...
  formatPagingInfos: function (infos, limit = 20) {
    ...
    pagingInfos.cursor =
      pagingInfos.after || pagingInfos.before ?
        JSON.parse(new Buffer.from(pagingInfos.after || pagingInfos.before, 'base64').toString('utf8'))
      : null;
    return pagingInfos;
  },
  /**
      ...
      if (randomSort) {
        ...
        function loop(currentQuery, index) {
          ...
          if (cursor && cursor.lastOrderingValues[ordering.sort]) {
            ...
            currentQuery.where(ordering.field, direction, lastValue).orWhere(function () {
